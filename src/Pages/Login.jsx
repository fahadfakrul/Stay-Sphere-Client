  ...
  return (
    <div className="flex w-full max-w-sm mx-auto overflow-hidden   rounded-xl mt-5 shadow-lg  lg:max-w-4xl">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://i.ibb.co/5TmPq7M/login.jpg')",
        }}
      ></div>
      ...
      <div className="w-full px-6 py-6 md:px-8 lg:w-1/2">
        ...
        <p className="mt-3 text-xl text-center text-blackdark:text-gray-200">
          Welcome back!
        </p>

        <a
          href="#"
          className="flex items-center justify-center mt-4 text-blacktransition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
        >
