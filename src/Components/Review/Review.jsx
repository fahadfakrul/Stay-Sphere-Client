      ...
      <section className="py-6 sm:py-12 dark:bg-gray-100 dark:text-gray-800">
        <div className="container p-6 mx-auto ">
          <div className="space-y-2 ">
            ...
            <p className="font-sans font-semibold text-base dark:text-gray-600">Read firsthand experiences from our satisfied customers.</p> 
          </div>
          <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
            {/* review card */}
            <div>
              <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800 border shadow-xl">
