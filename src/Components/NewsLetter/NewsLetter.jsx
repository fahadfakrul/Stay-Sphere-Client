    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-md">
          <p className="mb-5 text-white">To recieve our best monthly deals</p>
          ...
          <div className="flex flex-row bg-transparent p-2 bg-gray-900 bg-opacity-30 rounded-lg">
            ...
            <button
              type="button "
              className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 dark:bg-[#CC9933] hover:text-black  dark:text-white"
            >
              Subscribe
            </button>
          </div>
